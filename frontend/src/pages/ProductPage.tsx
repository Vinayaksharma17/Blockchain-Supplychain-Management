    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
          ...
          <div className="relative aspect-video md:aspect-[21/9] bg-gray-100 overflow-hidden">
            {!imageError ? (
              <img
            ...
            <span
              className={`absolute top-4 right-4 px-4 py-1.5 rounded-full text-sm font-medium backdrop-blur-sm ${
                ...
                {product.qr_file ? (
                  <>
                    ...
                    <p className="text-sm text-gray-500 text-center max-w-xs">
                      Scan this QR code to view the tracking information on your
                      mobile device.
                    </p>
                  </>
                ) : (
          ...
          <div className="relative pl-2">
            ...
            <div className="space-y-8 relative">
              {(trackingHistory || []).map((step, idx) => (
                <div
                  key={idx}
                  className="flex items-start ml-10 relative group"
                >
                  <div
                    className={`absolute -left-[2.65rem] w-4 h-4 rounded-full border-4 border-white shadow-sm ${
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              value={step.date}
                              onChange={(e) =>
                                updateTrackingStep(idx, 'date', e.target.value)
                              }
                              className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              value={step.loc}
                              onChange={(e) =>
                                updateTrackingStep(idx, 'loc', e.target.value)
                              }
                              className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 outline-none"
